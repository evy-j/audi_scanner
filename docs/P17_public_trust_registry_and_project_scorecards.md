# P17 — Public trust registry and project scorecards

## Objective

Add public verified report registry, risk trend scorecards, monitoring status pages, redaction rules, and no-certified-audit disclaimers.
