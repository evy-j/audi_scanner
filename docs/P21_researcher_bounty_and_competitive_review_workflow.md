# P21 — Researcher bounty and competitive review workflow

## Objective

Add bounty/contest lifecycle, submission triage, duplicate handling, reward accounting placeholders, and disclosure policy governance.
