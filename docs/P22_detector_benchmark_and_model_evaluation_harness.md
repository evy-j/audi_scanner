# P22 — Detector benchmark and model evaluation harness

## Objective

Add benchmark corpus metadata, detector precision regression tests, AI validation evals, false-positive tracking, and release gates.
